    ...
    <div class="row">
        <div class="col-12">
            <div class="text-center mb-4">
                <h1 class="display-4 pb-5">Citcon Hosted Online Payment (CHOP)</h1>
            </div>
        </div>
            ...
            <form class="form-chop" method="POST" action="payment-processing.php">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="alipay" name="vendor" class="custom-control-input" value="alipay" checked>
                        <label class="custom-control-label" for="alipay">Alipay</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="wechatpay" name="vendor" class="custom-control-input" value="wechatpay">
                        <label class="custom-control-label" for="wechatpay">Wechat Pay</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="cc" name="vendor" class="custom-control-input" value="cc">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="payment_process" id="payment_process" value="chop">
                </div>
